            ...
            <ul class="am-list admin-sidebar-list">
                ...
                <li class="admin-parent">
                    ...
                    <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
                        ...
                        <li><a href="#"><span class="am-icon-th"></span> 订单查看<span
                ...
                <div class="am-u-sm-12">
                    <form class="am-form">
                        <table class="am-table am-table-striped am-table-hover table-main">
                            ...
                            <tbody>
                                <c:forEach items="${sessionScope.orderPageBean.lists}" var="order">
                                    <tr>
                                    <td><input type="checkbox"/></td>
                                    <td>${order.oId}</td>
                                    <td>${order.user.uSignature}</td>
                                    <td>${order.uPhone}</td>
                                    <td class="am-hide-sm-only">${order.oAddress}</td>
                                    <td class="am-hide-sm-only">${order.orderUser.ouPayTime}</td>
                                    <td>${order.oCost}</td>
                                    <td>
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
